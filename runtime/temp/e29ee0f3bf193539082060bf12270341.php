<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpStudy\PHPTutorial\WWW\shumei\public/../application/admin\view\lnk\edit.html";i:1575019279;s:77:"D:\phpStudy\PHPTutorial\WWW\shumei\application\admin\view\layout\default.html";i:1574656895;s:74:"D:\phpStudy\PHPTutorial\WWW\shumei\application\admin\view\common\meta.html";i:1574656895;s:76:"D:\phpStudy\PHPTutorial\WWW\shumei\application\admin\view\common\script.html";i:1574656895;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-lnkname" data-rule="required" class="form-control" name="row[lnkname]" type="text" value="<?php echo htmlentities($row['lnkname']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Lnkurl'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-lnkurl" data-rule="required" class="form-control" name="row[lnkurl]" type="text" value="<?php echo htmlentities($row['lnkurl']); ?>">
        </div>
    </div>
    <div class="form-group">
